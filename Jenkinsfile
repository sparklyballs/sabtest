...
environment {
	...
	CONTAINER_REPOSITORY = 'sparklyballs/sabtest'
	GITHUB_RELEASE_URL_SUFFIX = 'sabnzbd/sabnzbd/releases/latest'
	GITHUB_REPOSITORY = 'sparklyballs/sabtest'
...
steps {
	...
	copyArtifacts fingerprintArtifacts: true, projectName: 'App-Builds/par2', selector: lastSuccessful()
	}
	}
